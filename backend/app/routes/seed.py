        ...
        await db.pipelines.insert_one({
            ...
            "nodes": [
                ...
                },
                {
                    ...
                    "step_title": "Темы",
                    "step_description": "Проверьте и отредактируйте список тем для анализа",
                    "continue_button_label": "Начать анализ",
                    "allow_add": True,
                    "allow_edit": True,
                    "allow_delete": True,
                    "min_selected": 1,
                ...
                },
                {
                    ...
                    "step_title": "Анализ",
                    "step_description": "Анализ тем выполняется по порциям",
                    "batch_size": 3,
                    "pause_after": True,
                    "continue_button_label": "Собрать документ",
                ...
                },
                {
                    ...
                    "step_title": "Результат",
                    "step_description": "Проверьте и при необходимости отредактируйте результат",
